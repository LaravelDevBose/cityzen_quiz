<template>
    <app-layout title="Create Question">
        <div class="py-12">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <div class="flex items-center">
                                                <input id="yes" v-model="form.right_ans" value="1"  name="right_ans" type="radio" class="focus:ring-indigo-500 h-5 w-5 text-indigo-600 border-gray-300" checked />
